...
//		};
//返回值：
var postDataPro_PostTnewsColl = function(commonData, wd, callback) {
	//需要加密的数据
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINURL + 'PostTnewsColl', enData, commonData, 0, wd, callback);
}
...
//		};
//返回值：
var postDataPro_PostTnewsCollList = function(commonData, wd, callback) {
	//需要加密的数据
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINURL + 'PostTnewsCollList', enData, commonData, 1, wd, callback);
}
...
var postDataPro_getMonthStatisticForMonth = function(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncry(storageKeyName.MAINJIAOXIAOURL + 'note/getMonthStatisticForMonth', enData, commonData, 2, wd, callback);
}
